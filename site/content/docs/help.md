...
Polyhymnia's `--help` flag provides an overview of the application's usage and the various [flags](/docs/flags) that can be used to customize queries and output.
...
Have an idea for a new feature or noticed something that isn’t working quite right? [Open an issue](https://github.com/pierow2k/polyhymnia/issues) to let us know. Your feedback helps us keep Polyhymnia reliable and feature-rich.
